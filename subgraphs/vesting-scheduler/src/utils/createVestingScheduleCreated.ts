...
import { VestingScheduleCreated as VestingScheduleCreated_v3 } from "../types/VestingScheduler_v3/VestingScheduler";
import { VestingScheduleCreated } from "../types/VestingScheduler/VestingScheduler";

export function createVestingScheduleCreatedEventEntity_v3(
  event: VestingScheduleCreated_v3
): VestingScheduleCreatedEvent {
  let ev = new VestingScheduleCreatedEvent(
    createEventID("VestingScheduleCreated", event, "v3")
  );
